...
def calcWeakScaling(algo):
    ...
    for version in versions:
        ...
        for i in range(len(cores)):
            ...
            filename = base_filename + version + "50_" + str(core) + ".csv"
            print(filename)
...
def process_folder_to_csv(folder_path, serial_filename):
    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith('.txt'):
            ...
            #test_vals = {2000,5000,7071,7500,10000,12500,14142,15000,17500,20000}
            test_vals = {500,1000,1500,2000,2500,3000}
